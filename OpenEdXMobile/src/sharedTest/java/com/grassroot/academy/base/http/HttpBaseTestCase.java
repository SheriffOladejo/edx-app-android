package com.grassroot.academy.base.http;
...
import com.grassroot.academy.base.Injector;
import com.grassroot.academy.course.CourseAPI;
import com.grassroot.academy.course.CourseService;
        ...
        try {
            if ("POST".equals(method)) {
                ...
                if (urlMatches(path, "/api/mobile/v0.5/my_user_info")) {
                    ...
                    response.setResponseCode(HttpStatus.OK);
                } else if (urlMatches(path, "/api/mobile/v2/users/[^/]+/course_enrollments")) {
                    String baseMockUrl = getBaseMockUrl();
                    response.setBody(String.format(Locale.US, MockDataUtil.getMockResponse("get_course_enrollments_v2"), baseMockUrl));
                    response.setResponseCode(HttpStatus.OK);
