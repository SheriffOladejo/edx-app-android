package com.grassroot.academy.module.prefs
...
class AppFeaturesPrefs @Inject constructor(@ApplicationContext context: Context) {
     ...
     * The App will allow the user to purchase the course only if [com.grassroot.academy.model.api.IAPConfig.isEnabled] is true
     * If [com.grassroot.academy.model.api.IAPConfig.isExperimentEnabled] is true then only treatment group will be able to buy the course.
     */
