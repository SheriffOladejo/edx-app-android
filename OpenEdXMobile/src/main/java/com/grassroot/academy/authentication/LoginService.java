...
import static com.grassroot.academy.http.constants.ApiConstants.URL_MY_USER_INFO;
...
import com.grassroot.academy.http.constants.ApiConstants.TokenType;
...
public interface LoginService {
     ...
     * In case of validation errors the response body will be {@link com.grassroot.academy.model.api.FormFieldMessageBody}.
     */
    @NonNull
    @FormUrlEncoded
