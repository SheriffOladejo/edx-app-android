...
import com.grassroot.academy.databinding.SubItemCourseDateBlockBinding
import com.grassroot.academy.interfaces.OnDateBlockListener
import com.grassroot.academy.model.course.CourseDateBlock
import com.grassroot.academy.model.course.CourseDateType
...
object DataBindingHelperUtils {
    ...
    private fun createBadge(textView: TextView, courseDateType: CourseDateType) {
        ...
        addDateBadge(
            textView,
            courseDateType.getStringResIdForDateType(),
            badgeBackground,
            textAppearance,
            badgeIcon,
            badgeStrokeColor
    ...
    private fun addDateBadge(
        textView: TextView, titleRes: Int, badgeBackground: Int, textAppearance: Int,
